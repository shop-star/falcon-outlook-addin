...
There's currently no way to export the traced plan or its room data out of
the add-in — **Copy results** (step 5 above) is the only way to get your
numbers out, as a tab-separated list you can paste into Excel or a quote.
